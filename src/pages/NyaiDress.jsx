    ...
    <div className="page-container">
      <div className="product-container">
        <div className="product-image-detail">
          <img src="/product1.jpg" alt="Nyai Dress" />
        </div>
        <div className="product-info">
          <h1>Nyai Dress</h1>
          <p className="price">Rp 4.565.000</p>
          ...
          <div className="tabs">
              ...
              <div className={`tab-content ${activeTab === 'desc' ? 'active' : ''}`}>
                  <strong>Description:</strong> MIDI DRESS WITH DETAILED CUT OUT BODICE
                  <br /><br />
                  <strong>Fabric:</strong> JACQUARD
                  <br /><br />
                  <strong>Composition:</strong> 100% POLYESTER
                  <br /><br />
                  <strong>Colorway:</strong> Sage Green.
              </div>
