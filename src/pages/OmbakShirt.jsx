    ...
    <div className="page-container">
      <div className="product-container">
        <div className="product-image-detail">
          <img src="/product5.jpg" alt="Ombak Shirt" />
        </div>
        <div className="product-info">
          <h1>Ombak Shirt</h1>
          <p className="price">Rp 2.970.000</p>
          ...
          <div className="tabs">
              ...
              <div className={`tab-content ${activeTab === 'desc' ? 'active' : ''}`}>
                  <strong>Description:</strong> SHIRT WITH PLEATED SLEEVES SHIRT COLLAR AND EMBROIDERED HEM
                  <br /><br />
